...
export class FileHelper {
    private fileName = '';
    private allowedFileTypes: string[] = ['.csv', '.json'];
    ...
    constructor(file: File | string){
        ...
        if(this.isValidFileType(fileName) && this.isValidFileName(fileName)){
    ...
    private isValidFileType(fileName: string): boolean {
        let extension:string | undefined = fileName && fileName.split('.').length ? fileName.split('.').pop() : '';
