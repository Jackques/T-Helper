...
describe('Auto Reminder Test', () => {
    ...
    it('Test - Get Reminder HTTP no reminders sent yet', () => {
        ...
        const reminderHttp: ReminderHttp = new AutoReminder().getReminderHttpMap(id, completeId, name, usedReminderTextMessageList, isEnglish);
