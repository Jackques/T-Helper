...
export const screensTinder: Screen[] = [
    ...
    new Screen(
        ScreenNavStateComboTinder.SwipeDetail, [
    ...
    new Screen(ScreenNavStateComboTinder.SwipeExploreDetail, [
        new ScreenAction('like', 'div[class*="Bgi\\($g-ds-overlay-profile-button-gamepad\\)"] button:contains("Like"):not(:contains("Super"))'),
        new ScreenAction('pass', 'div[class*="Bgi\\($g-ds-overlay-profile-button-gamepad\\)"] button:contains("Nope")'),
        new ScreenAction('superlike', 'div[class*="Bgi\\($g-ds-overlay-profile-button-gamepad\\)"] button:contains("Super Like")')
    ], [
...
function getDOMPathForJob(): HTMLElement | null {
    ...
    const jobDOMRow_SWIPEGOLD_SWIPEDETAIL = $("div.profileCard__card path[d='" + jobSVG_D_properties + "']");
    const jobDOMRow_SWIPE_EXPLORE = $("div.recsCardboard__cards div[aria-hidden='false'] path[d='" + jobSVG_D_properties + "']");

    let jobDOMRow: HTMLElement | undefined = undefined;
...
function getDOMPathForSchool(): HTMLElement | null {
    ...
    const schoolDOMRow_SWIPEGOLD_SWIPEDETAIL = $("div.profileCard__card path[d='" + schoolSVG_D_properties + "']");
    const schoolDOMRow_SWIPE_EXPLORE = $("div.recsCardboard__cards div[aria-hidden='false'] path[d='" + schoolSVG_D_properties + "']");

    let schoolDOMRow: HTMLElement | undefined = undefined;
...
function getDOMPathForCity(): HTMLElement | null {
    ...
    const cityDOMRow_SWIPEGOLD_SWIPEDETAIL = $("div.profileCard__card path[d='" + citySVG_D_properties + "']");
    const cityDOMRow_SWIPE_EXPLORE = $("div.recsCardboard__cards div[aria-hidden='false'] path[d='" + citySVG_D_properties + "']");

    let cityDOMRow: HTMLElement | undefined = undefined;
...
function getDOMPathForDistance(): HTMLElement | null {
    ...
    const distanceDOMRow_SWIPEGOLD_SWIPEDETAIL = $("div.profileCard__card path[d='" + distanceSVG_D_properties + "']");
    const distanceDOMRow_SWIPE_EXPLORE = $("div.recsCardboard__cards div[aria-hidden='false'] path[d='" + distanceSVG_D_properties + "']");

    let distanceDOMRow: HTMLElement | undefined = undefined;
