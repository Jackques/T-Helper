...
export class DataRecord {
    ...
    public usedDataFields:DataField[] = [
        ...
        new DataField('Age', 'The age of the person', true, { UIrequired: UIRequired.SELECT_ONLY, UIrequiredType: UIRequiredType.ALPHANUMERIC_INPUT }, false, false, true, true, {baseType: 'number', customCheckClass: null}), // preferably getting this by birthdate otherwise just the age number is fine too
        ...
        new DataField('Is-verified', 'Wether or not this person is verified', true, { UIrequired: UIRequired.CHAT_ONLY, UIrequiredType: UIRequiredType.SLIDER }, false, false, true, true, {baseType: 'boolean', customCheckClass: null}),
