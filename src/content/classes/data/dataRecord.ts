...
export class DataRecord {
    ...
    public usedDataFields:DataField[] = [
        ...
        new DataField('Is-verified', 'Wether or not this person is verified', true, { UIrequired: UIRequired.SELECT_ONLY, UIrequiredType: UIRequiredType.SLIDER }, false, false, true, true, {baseType: 'boolean', customCheckClass: null}),
