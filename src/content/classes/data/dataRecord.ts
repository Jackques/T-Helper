...
export class DataRecord {
    ...
    public usedDataFields:DataField[] = [
        ...
        new DataFieldSystemNo('System-no', 'The number the system of the datingapp assigned this person to', false, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, true, {baseType: 'specialList', customCheckClass: new dataCheckSystemId()}),
        new DataField('No', 'The number of the person for my app internaly', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, true, false, true, {baseType: 'number', customCheckClass: null}),
        new DataFieldMessages('Messages', 'The messages sent between me and my match', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'specialList', customCheckClass: new dataCheckMessage()}),
        new DataField('Last-updated', 'The datetime this record has been last updated (including messages)', false, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'string', customCheckClass: new dataCheckDate()}),
        

        // need to keep track of this myself, but since I'M swiping/liking this will not be a problem 
        new DataField('Date-liked-or-passed', 'The datetime when I gave the like/sent my first message/disliked/counsiously ignored this potential person', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, true, {baseType: 'string', customCheckClass: new dataCheckDate()}),
        new DataField('Name', 'The name of the person', true, { UIrequired: UIRequired.SELECT_ONLY, UIrequiredType: UIRequiredType.ALPHANUMERIC_INPUT }, false, false, true, true, {baseType: 'string', customCheckClass: null}),
        new DataField('Age', 'The age of the person', true, { UIrequired: UIRequired.SELECT_ONLY, UIrequiredType: UIRequiredType.NUMERIC_INPUT }, false, false, true, true, {baseType: 'number', customCheckClass: null}), // preferably getting this by birthdate otherwise just the age number is fine too
        ...
        new DataField('Has-profiletext', 'Wether or not this person has some text on the profile', true, { UIrequired: UIRequired.ALL, UIrequiredType: UIRequiredType.SWITCH }, false, false, true, true, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Has-usefull-profiletext', 'Wether or not this person has some usefull text on the profile', true, { UIrequired: UIRequired.ALL, UIrequiredType: UIRequiredType.SWITCH }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        ...
        new DataField('Needs-profile-update', 'If a match profile details need to be updated for this record', true, { UIrequired: UIRequired.ALL, UIrequiredType: UIRequiredType.SWITCH }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Needs-messages-update', 'If a match messages need to be updated for this record', true, { UIrequired: UIRequired.ALL, UIrequiredType: UIRequiredType.SWITCH }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        ...
        new DataFieldDistances('Distance-in-km', 'The reported distance of this person relative to me on a given datetime', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, true, false, true, false, {baseType: 'specialList', customCheckClass: new dataCheckDistances()}),
        ...
        new DataField('Gender', 'The gender of this person', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, true, {baseType: 'string', customCheckClass: null}),
        ...
        new DataField('Type-of-match-or-like', 'The type of match or like me and my match might have exchanged', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, true, false, false, false, {baseType: 'specialList', customCheckClass: new dataCheckListStrings()}),
        new DataField('Is-verified', 'Wether or not this person is verified', true, { UIrequired: UIRequired.SELECT_ONLY, UIrequiredType: UIRequiredType.SWITCH }, false, false, true, true, {baseType: 'boolean', customCheckClass: null}),
        ...
        new DataField('Did-i-like', 'Wether I liked/showed interest in this person', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Is-match', 'Wether we have a match/can talk/person liked me back or not', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Date-match', 'The datetime when I and the person had a match/ability to talk', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'string', customCheckClass: new dataCheckDate()}),
        new DataField('Match-sent-first-message', 'If this person sent me a first message', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}), // not-yet (if she did not yet send me a message within a certain time-period), no (if she did not send me a first message within a certain timeperiod after being matched), yes (if she did send me a first message within a certain time-period)
        new DataField('Match-responded', 'If this person responded to my first message', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Conversation-exists', 'If this person responded to each of my first 3 messages to this person', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        ...
        new DataFieldGhostsList('How-many-ghosts', 'How many times this person did respond in a certain timeframe', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'specialList', customCheckClass: new dataCheckGhosts()}),
        ...
        new DataFieldReactionSpeedList('Response-speed', 'The moments of time between each response', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'specialList', customCheckClass: new dataCheckReactionSpeed()}), // de dagen & tijden tussen de eerste nieuwe berichten vanuit de ander
        new DataFieldReminderList('Reminders-amount', 'The amount of reminders I sent and if they worked', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'specialList', customCheckClass: new dataCheckReminders()}),
        new DataField('Match-wants-no-contact', 'If this person indicated they did not wish further contact', true, { UIrequired: UIRequired.CHAT_ONLY, UIrequiredType: UIRequiredType.SWITCH }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Blocked-or-removed', 'If this person certainly blocked my profile/removed us as match', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
        new DataField('Date-of-unmatch', 'The datetime the match was removed', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'string', customCheckClass: new dataCheckDate()}),
        new DataField('Seemingly-deleted-profile', 'If this person seemingly (i.e. request to match profile returns a 404) deleted their profile', true, { UIrequired: UIRequired.NONE, UIrequiredType: null }, false, false, false, false, {baseType: 'boolean', customCheckClass: null}),
    ...
    */
    ...
    public getAllAutoGatherDataFields(): DataField[] {
        return this.usedDataFields.filter((dataField: DataField) => {
