...
import { dataDate } from "./dataLogic/dataDate";
...
class DataRecord {
    ...
    public usedDataFields:DataField[] = [
        ...
        new DataField('Geverifieerd', 'Wether or not this person has some text on the profile', true, false, false, false, true, true, {baseType: 'boolean', checkMethod: null}),
            new DataField('Aantrekkelijkheidsscore', '', true, true, true, false, false, false, {baseType: 'number', checkMethod: null}), // NOTE! attractiveness rating on photo's can be 1, 2, 3, 6.5, 6, 7,5, 8 etc. but also: NAN (no photo available when there is litterally no photo?)
        ...
        new DataField('Gesprek-op-gang', 'If this person sent at least one message in between my first 3 messages', true, false, false, false, true, false, {baseType: 'boolean', checkMethod: null}),
            new DataField('Gevoel-van-gemak-gesprek', 'The feeling of how easy & fun it is to have a conversation with this person ranging from 1 (very responsive & fun) to 6 (hardly responsive & teeth pulling)', false, true, true, false, false, false, {baseType: 'integer', checkMethod: null}),
            new DataField('Hoe-vaak-ghost', 'How many times this person did not respond in a certain timeframe', false, false, true, false, true, false, {baseType: 'list', checkMethod: null}),
        new DataField('Nummer-verkregen', 'Did I get further contact details (e.g. phone number) from this person?', false, true, false, false, false, false, {baseType: 'boolean', checkMethod: null}),
            new DataField('Reactie-snelheid', 'The moments of time between each response', false, false, true, false, true, false, {baseType: 'list', checkMethod: null}), // de dagen & tijden tussen de eerste nieuwe berichten vanuit de ander
    ...
    'howManyReminders' // because I want to keep track of how many reminders I sent.. AND if they worked?
    ...
    'vibe-tags', // because I want to keep track of the characteristics // vibe i get from this person; religious, trashy, into-sports, outdoorsy, nerdy, dominant, submissive, sexual, etc.
        ZET HIER WELKE TAGS IK MOMENTEEL WEL GA ONDERSTEUNEN EN WELKE NIET! BEGIN KLEIN! */
